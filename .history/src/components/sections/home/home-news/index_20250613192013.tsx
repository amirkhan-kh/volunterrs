        ...
        <div className="flex gap-4 w-max">
          {newsDb.map((item, i) => (
            <a
              ...
              className="w-[285px] sm:w-[345px]  bg-sky-400 shadow rounded-lg p-2 relative"
            >
              <img
                src={item.img}
                alt=""
             ...
             <div className="mb-3">
              ...
              <div className="flex items-center  text-sm absolute top-[178px] left-[120px] sm:left-[190px] w-36 bg-white py-1 px-5 rounded-sm text-[#6495ED] text-[14px]">
