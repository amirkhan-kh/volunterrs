  ...
  return (
    <div className="px-2 sm:px-20 py-10 w-full">
      <div className="flex items-center justify-between ">
        <Button onClick={() => window.history.back()} className="bg-transparent hover:bg-[#6494ed20] border border-[#6495ED]">
          <IoIosArrowBack color="#6495ED" />
        </Button>
        <p className="text-[18px] sm:text-[30px] font-semibold text-[#2F2E2E]">
      ...
      <div className="flex flex-col items-center justify-center py-14 px-3">
        ...
        <form className="px-6 w-[310px] sm:w-[530px] space-y-6 mt-8">
          <div>
          ...
          <div className="space-y-4">
            <p className="text-[#2F508C] font-semibold">Ijtimoiy tarmoqlar</p>
