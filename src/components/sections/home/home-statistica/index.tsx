    ...
    <div className='container mx-auto px-4 lg:px-[100px] py-10 flex flex-col gap-20'>
      ...
      <div className=" flex flex-col sm:flex-row  gap-8 shadow-[0px_2px_8px_rgba(99,99,99,0.2)] w-full p-4 rounded-[8px]">
        ...
        <div className='flex flex-col justify-between h-full gap-5'>
          <h3 className='text-[22px] font-semibold leading-[40px] x'>Volontyorlar kerekmi ?</h3>
          <ul>
            <li className='text-[14px] border-b border-[#EAEAEA] leading-6 mb-2.5'>Agarda sizga volontyor kerak bolsa, bizning volontyorlar siz uchun doimo yordamga tayyor</li>
            <li className='text-[14px] leading-6 mb-2.5'>Volontyorlar hizmatidan foydalanish uchun bosing</li>
          </ul>
          <Button className='bg-[#6495ED] hover:bg-[#85a8ffed]   rounded-[12px] w-full'>Volontyorlar</Button>
        </div>
      </div>
    </div>
  )
